...
$products = [
    ...
    // Веб-камеры
    ['Logitech C920 HD Pro',        'Logitech',    'Веб-камера Full HD 1080p с автофокусом и стереомикрофонами. Совместима с Zoom, Teams и другими платформами.',                                                                                               6990, '/public/mouse.png',      'Веб-камеры', 22, null],
    ['Razer Kiyo Pro',              'Razer',       'Стриминговая веб-камера с адаптивным световым сенсором и разрешением 1080p/60fps.',                                                                                                                         9990, '/public/mouse.png',      'Веб-камеры', 11, 'Новинка'],
